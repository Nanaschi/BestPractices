		...
		private void ConditionGUI(ParameterConditionProperty conditionProperty)
		{
			...
			switch (parameterType)
			{
				...
				case Parameter.Type.Vector4:
					{
						_LayoutArea.PropertyField(valueProperty, EditorGUITools.GetTextContent("Vector4 Value"));
					}
					break;
				case Parameter.Type.Vector2Int:
					{
						_LayoutArea.PropertyField(valueProperty, EditorGUITools.GetTextContent("Vector2Int Value"));
					}
					break;
				case Parameter.Type.Vector3Int:
					{
						_LayoutArea.PropertyField(valueProperty, EditorGUITools.GetTextContent("Vector3Int Value"));
					}
					break;
				case Parameter.Type.RectInt:
					{
						_LayoutArea.PropertyField(valueProperty, EditorGUITools.GetTextContent("RectInt Value"));
					}
					break;
				case Parameter.Type.BoundsInt:
					{
						_LayoutArea.PropertyField(valueProperty, EditorGUITools.GetTextContent("BoundsInt Value"));
					}
					break;
				case Parameter.Type.Transform:
					{
						...
						flexibleComponentProperty.overrideConstraintType = typeof(Transform);
						_LayoutArea.PropertyField(flexibleComponentProperty.property, EditorGUITools.GetTextContent("Transform Value"));
					}
					break;
				case Parameter.Type.RectTransform:
					{
						FlexibleComponentProperty flexibleComponentProperty = new FlexibleComponentProperty(valueProperty);
						flexibleComponentProperty.overrideConstraintType = typeof(RectTransform);
				...
				case Parameter.Type.Rigidbody:
					{
						FlexibleComponentProperty flexibleComponentProperty = new FlexibleComponentProperty(valueProperty);
						flexibleComponentProperty.overrideConstraintType = typeof(Rigidbody);
				...
				case Parameter.Type.Rigidbody2D:
					{
						FlexibleComponentProperty flexibleComponentProperty = new FlexibleComponentProperty(valueProperty);
						flexibleComponentProperty.overrideConstraintType = typeof(Rigidbody2D);
				...
				case Parameter.Type.Component:
					{
						FlexibleComponentProperty flexibleComponentProperty = new FlexibleComponentProperty(valueProperty);
						flexibleComponentProperty.overrideConstraintType = conditionProperty.GetReferenceType();
