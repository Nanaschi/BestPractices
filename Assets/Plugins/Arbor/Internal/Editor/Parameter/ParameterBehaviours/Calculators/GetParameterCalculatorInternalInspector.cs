...
namespace ArborEditor.ParameterBehaviours
{
	...
	internal sealed class GetParameterCalculatorInternalInspector : CalculatorBehaviourEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			else
			{
				if (_ParameterReferenceProperty.type == ParameterReferenceType.DataSlot)
				{
					...
					_OutputProperty.typeProperty.property.SetStateData(new TypeFilterAttribute(filterFlags));
