...
namespace Arbor
{
	...
	public class NodeBehaviour : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		private class FlexibleSceneObjectsReceiver : EachField<IFlexibleField>.IFindReceiver
		{
			public NodeBehaviour nodeBehaviour
			{
				get;
			...
			public FlexibleSceneObjectsReceiver(NodeBehaviour nodeBehaviour)
			{
				this.nodeBehaviour = nodeBehaviour;
			}

			public void OnFind(IFlexibleField field, System.Reflection.FieldInfo fi)
			{
				...
				flexibleObject.ownerObject = nodeBehaviour;
				flexibleObject.fieldInfo = fi;
			}
		}

		private FlexibleSceneObjectsReceiver _FlexibleSceneObjectsReceiver = null;

		void RebuildFlexibleSceneObjects()
		{
			if (_FlexibleSceneObjectsReceiver == null || _FlexibleSceneObjectsReceiver.nodeBehaviour != this)
			{
				_FlexibleSceneObjectsReceiver = new FlexibleSceneObjectsReceiver(this);
			}
			EachField<IFlexibleField>.Find(this, this.GetType(), _FlexibleSceneObjectsReceiver);
		}
